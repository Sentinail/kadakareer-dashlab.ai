			...
			<ExtractDocumentPageContainerStyles>
				<div className="hero_section">
					<ExtractDocumentDescription
						title={"Extract DPRS Document Data"}
					>
						This DPRS Document Extraction Tool empowers you to effortlessly
						extract key-value pairs and table datas from DPRS document you provide or input.
				...
				<div className="extraction_section">
					<ExtractionInputSection
						url={"http://localhost:9000/api/DOH-PEMER-SB"}
						setResult={setResult}
					></ExtractionInputSection>
					{result && (
...
export default ExtractDPRSDocument;
